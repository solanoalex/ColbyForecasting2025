...
obs = read_observations(scientificname = "Pandalus borealis", individual_na = F) |>
  filter(month == "Aug")
...
for (this_month in month.abb){
  result = make_model_input_by_month(this_month,
                                     obs = read_observations(scientificname = "Pandalus borealis",
                                                             individual_na = F),
                                     raster = mask,
...
```{r}
read_model_input(scientificname = "Pandalus borealis",
                 mon = "Nov",
