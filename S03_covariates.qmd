...
for (month in month.abb){
  greedy = select_covariates(approach = "greedy", mon = month, scientificname = "Pandalus borealis", must_have_depth = TRUE)
  
  conservative = select_covariates(approach = "conservative", mon = month, scientificname = "Pandalus borealis", must_have_depth = TRUE)
