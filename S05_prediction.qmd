...
for(month in month.abb){
  ...
  if(inherits(cfg, "try-error")){
    ...
    write_prediction(nowcast, file = file.path(path, paste("g_", month, "RCP85_2020.tif", sep = "")))
    write_prediction(forecast_2055, file = file.path(path, paste("g_", month, "_RCP85_2055.tif", sep = "")))
    write_prediction(forecast_2075, file = file.path(path, paste("g_", month, "_RCP85_2075.tif", sep = "")))
...
for(month in month.abb){
  ...
  if(inherits(cfg, "try-error")){
    ...
    write_prediction(nowcast, file = file.path(path, paste("c_", month, "RCP85_2020.tif", sep = "")))
